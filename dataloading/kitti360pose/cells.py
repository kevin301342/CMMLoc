...
from datapreparation.kitti360pose.utils import CLASS_TO_INDEX, COLOR_NAMES,CLASS_TO_COLOR
...
class Kitti360CoarseDataset(Kitti360BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        object_color_label = [obj.get_color_text() +" "+ obj.label for obj in cell.objects]
        ...
        return {
            ...
            "object_color_label":object_color_label,
